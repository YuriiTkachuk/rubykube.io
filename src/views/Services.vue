  ...
  <div>
    ...
    <div id="friends" class="index-features-friends">
      <section class="clearfix">
        <img src="../assets/images/devices/devices-7.png" class="browser" />
    ...
    <div id="camera" class="index-features-camera">
      <section>
        ...
        <div class="pic">
          <img src="../assets/images/devices/devices-5.png" class="img-fluid" />
        </div>
      </section>
    </div>
    ...
    <div id="user" class="index-features-user">
      ...
      <section class="clearfix">
        <img src="../assets/images/devices/iphone-14.png" class="devices float-right" />
          ...
          <div class="col col-left">
            ...
            <div class="features">
              <div class="feature clearfix">
                <div class="image">
                  <img src="../assets/images/icons/features-icon-upload.png" />
                </div>
                <div class="info">
                  <strong>
              ...
              <div class="feature clearfix">
                <div class="image">
                  <img src="../assets/images/icons/features-icon-earth.png" />
                </div>
                <div class="info">
                  <strong>
              ...
              <div class="feature clearfix">
                <div class="image">
                  <img src="../assets/images/icons/features-icon-repeat.png" />
                </div>
                <div class="info">
                  <strong>
                    Easy to customize
